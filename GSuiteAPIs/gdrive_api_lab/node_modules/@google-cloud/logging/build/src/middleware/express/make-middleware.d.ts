 ...
 * request log.
 */
export declare function makeMiddleware<LoggerType>(projectId: string, makeChildLogger: (trace: string) => LoggerType, emitRequestLog?: (httpRequest: StackdriverHttpRequest, trace: string) => void): (req: http.IncomingMessage, res: http.ServerResponse, next: Function) => void;
