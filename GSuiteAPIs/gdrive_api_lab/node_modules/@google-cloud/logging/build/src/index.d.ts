...
export declare type GetSinksResponse = [Sink[], google_config.logging.v2.IListSinksRequest, google_config.logging.v2.IListSinksResponse];
export interface GetSinksCallback {
    (err: Error | null, entries?: Sink[], request?: google_config.logging.v2.IListSinksRequest, apiResponse?: google_config.logging.v2.IListSinksResponse): void;
}
...
declare class Logging {
     ...
     *   });
     */
    getSinksStream(options: GetSinksRequest): any;
    /**
     ...
     * @private
     */
    setAclForBucket_(name: string, config: CreateSinkRequest, callback: CreateSinkCallback): void;
    /**
     ...
     * @private
     */
    setAclForDataset_(name: string, config: CreateSinkRequest, callback: CreateSinkCallback): void;
    /**
     ...
     * @private
     */
    setAclForTopic_(name: string, config: CreateSinkRequest, callback: CreateSinkCallback): void;
}
/**
 * {@link Entry} class.
 *
